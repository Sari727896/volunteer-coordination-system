...
export default class RequestsApi {
  ...
  private setRoutes() {
    ...
    this.router.get(
      ...
      async (req: Request, res: Response) => {
        try {
          ...
          let results: Array<HelpRequest>;
          results = await this.requestsService.GetByFiltering(
            stringLocation,
            statusStatus,
            priorityPriority
          );
    ...
    this.router.post(
      ...
      async (req: Request, res: Response) => {
        try {
          ...
          const result = await this.requestsService.createHelpRequest(
            newRequest
          );
    ...
    this.router.post("/volunteer", async (req: Request, res: Response) => {
      ...
      try {
        const result = await this.requestsService.volunteerForRequest(
          requestId,
          volunteerId
        );
        if (result) {
